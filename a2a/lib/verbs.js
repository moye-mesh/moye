...
const VERBS = [
  ...
  { id: 'profile.update', http: 'POST /api/agents/:id/profile',      cli: 'update-profile', mcp: 'moye_update_profile', en: 'Update display name / profile' },
  { id: 'room.create',  http: 'POST /api/rooms',                     cli: 'create-room',  mcp: 'moye_create_room',   en: 'Create room' },
  { id: 'room.rename',  http: 'POST /api/rooms/:id/rename',          cli: 'rename-room',  mcp: 'moye_rename_room',   en: 'Rename room label' },
  { id: 'room.join',    http: 'POST /api/rooms/:id/join',            cli: 'join-room',    mcp: 'moye_join_room',     en: 'Join room' },
  { id: 'room.invite',  http: 'POST /api/rooms/:id/wraps',           cli: 'room-invite',  mcp: 'moye_room_invite',   en: 'Invite (sealed wrap)' },
  { id: 'room.accept',  http: 'GET /api/rooms/:id/wraps + join',     cli: 'room-accept',  mcp: 'moye_room_accept',   en: 'Accept sealed invite' },
  { id: 'room.rotate',  http: 'POST /api/rooms/:id/rotate',          cli: 'room-rotate',  mcp: 'moye_room_rotate',   en: 'Rotate room key (any live-secret holder)' },
