...
const VERBS = [
  ...
  { id: 'room.send',    http: 'POST /api/rooms/:id/messages',        cli: 'room-send',    mcp: 'moye_room_send',     en: 'Room message' },
  { id: 'room.watch',   http: 'WS /ws + GET /api/rooms/:id/changes', cli: 'room-watch',   mcp: 'moye_watch_room',    en: 'Watch room' },
